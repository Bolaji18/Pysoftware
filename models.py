class Question(TenantAwareModel):
    ...
    multiple_quiz_use_subject = models.ManyToManyField(Subjects,
    related_name="quiz_questions")
    question_severity = models.CharField(null=True, blank=True, max_length=1, choices=SEVERITY)
    question_preamble = HTMLField(help_text="Any preamble or Information needed for the main question", default="", null=True, blank=True)
    question_main = HTMLField(help_text="Question", null=True, blank=True,max_length=50000)
